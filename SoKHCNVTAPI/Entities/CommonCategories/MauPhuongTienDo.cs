...
// Mẫu phương tiện đo - tt15
[Table("MauPhuongTienDo", Schema = "skhcn")]
public class MauPhuongTienDo
{
    [Key]
...
public class MauPhuongTienDoDto
{
    [StringLength(200)]
    public required string Ten { get; set; }
...
public class MauPhuongTienDoFilter : PaginationDto, IKeyword
{
