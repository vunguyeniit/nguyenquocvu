...
// HinhThucChuyenGiao -> Gán tổ chức
[Table("HinhThucChuyenGiao", Schema = "skhcn")]
public class HinhThucChuyenGiao
{
    [Key]
 ...
 public class HinhThucChuyenGiaoDto
{
    [StringLength(200)]
    public required string Ten { get; set; }
...
public class HinhThucChuyenGiaoFilter : PaginationDto, IKeyword
{
