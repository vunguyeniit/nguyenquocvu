...
[Table("LinhVucNghienCuuTTQT", Schema = "skhcn")]
public class LinhVucNghienCuuTTQT
{
    [Key]
...
public class LinhVucNghienCuuTTQTDto
{
    [StringLength(200)]
    public required string Ten { get; set; }
    ...
    public class LinhVucNghienCuuTTQTFilter : PaginationDto, IKeyword
{
