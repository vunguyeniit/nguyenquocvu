...
[Table("HinhThucThanhLap", Schema = "skhcn")]
public class HinhThucThanhLap
{
    [Key]
...
public class HinhThucThanhLapDto
{
    [StringLength(200)]
    public required string Ten { get; set; }
...
public class HinhThucThanhLapFilter : PaginationDto, IKeyword
{
