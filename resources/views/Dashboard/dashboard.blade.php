				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active">
						...
						<ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
							...
							<li class="sidebar-item active"><a class="sidebar-link" href="dashboard-ecommerce.html">E-Commerce <span class="sidebar-badge badge bg-primary">Pro</span></a></li>
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <canvas id="chartjs-dashboard-line" style="display: block; width: 661px; height: 300px;" width="661" height="300" class="chartjs-render-monitor"></canvas>
									</div>
								</div>
							</div>
						</div>
