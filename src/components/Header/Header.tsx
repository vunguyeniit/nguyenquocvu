...
export const Header = () => {
  ...
  return (
    <div className='text-white pb-5 pt-2 bg-[linear-gradient(-180deg,#f53d2d,#f63)]'>
        ...
        <div className='flex justify-end'>
              ...
              <div className='flex items-center py-1 :hover text-gray-300 cursor-pointer'>
                <div className='w-6 h-6 mr-2 flex-shrink-0'>
                  <img
                    ...
                    src='https://down-vn.img.susercontent.com/file/c96dc0b3094fe8a4159cdd98568b1c51_tn'
                    alt='avatar'
                  />
                </div>
          ...
          {!isAuthenticated && (
            <div className='flex items-center'>
              <Link to={path.register} className='mx-3 capitalize hover:text-while,70'>
                Đăng ký
              </Link>
              <div className='border-r-[1px] border-r-while/40 h-4' />
              <Link to={path.login} className='mx-3 capitalize hover:text-while,70'>
                Đăng nhập
              </Link>
            </div>
          )}
          {/* <div className='flex items-center py-1 :hover text-gray-300 cursor-pointer'>
            ...
            <div className=''>nquocvu</div>
          </div> */}
        </div>
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to='/' className='col-span-2'>
            <svg viewBox='0 0 192 65' className=' w-full h-5 lg:h-11 fill-white'>
              <g>
          ...
          <form className='col-span-9'>
            <div className='bg-white rounded-sm p-1 flex'>
              ...
              />
              <button className='rounded-sm py-2 px-6 flex-shrink-0 :hover:opacity-90 bg-orange'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
                      ...
                      <div className='mt-5'>
                        <div className='mt-4 flex'>
                          ...
                          <div className='flex-grow ml-2 overflow-hidden'>
                            <div className='truncate'>Dưỡng chất da</div>
                          </div>

                          <div className='ml-2 flex-shrink-0'>
                            <span className='text-orange'>4960</span>
                          </div>
                        </div>
